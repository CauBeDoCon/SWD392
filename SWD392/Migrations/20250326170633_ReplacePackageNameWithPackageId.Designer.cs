...
namespace SWD392.Migrations
{
    ...
    [Migration("20250326170633_ReplacePackageNameWithPackageId")]
    partial class ReplacePackageNameWithPackageId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SWD392.DB.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SWD392.DB.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SWD392.DB.PackageSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TimeSlot1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TimeSlot2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TimeSlot3")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TimeSlot4")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PackageSessions");
                });

            modelBuilder.Entity("SWD392.DB.PackageTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SWD392.DB.Room", b =>
                {
            ...
            modelBuilder.Entity("SWD392.DB.RoomCheckin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SWD392.DB.TreatmentSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SWD392.DB.ApplicationUser", b =>
                {
                    b.HasOne("SWD392.DB.Appointment", "Appointment")
                        .WithOne("User")
                        .HasForeignKey("SWD392.DB.ApplicationUser", "AppointmentId")
            ...
            modelBuilder.Entity("SWD392.DB.Appointment", b =>
                {
                    b.HasOne("SWD392.DB.Package", "Package")
            ...
            modelBuilder.Entity("SWD392.DB.Package", b =>
                {
                    b.HasOne("SWD392.DB.ApplicationUser", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId");
            ...
            modelBuilder.Entity("SWD392.DB.PackageTracking", b =>
                {
                    b.HasOne("SWD392.DB.TreatmentSession", "TreatmentSession")
                        .WithMany("PackageTrackings")
            ...
            modelBuilder.Entity("SWD392.DB.RoomCheckin", b =>
                {
                    ...
                    b.HasOne("SWD392.DB.ApplicationUser", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SWD392.DB.Room", "Room")
